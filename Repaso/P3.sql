...
-- con DNI 30948214 debe mostrarse si pertenece a la localidad n√∫mero 3. 

        SELECT V.NOMBRECOMPLETO, V.DNI, V.LOCALIDAD
        FROM VOTANTES V 
        WHERE V.LOCALIDAD+1 = MOD(V.DNI,10);
  
-- 2. Obtener el nombre de todos los votantes asÌ como el nombre de 
...
-- 2 y 3) se han mudado a Madrid. 
     ...
     /*
        ...
        Traduce una expresiÛn a un valor de retorno. Si expr es igual a value1, 
        la funciÛn devuelve Return1. Si expr es igual a value2, la funciÛn 
...
-- participado	un	mayor	numero	de	veces	en	eventos.	 
    ...
    FROM PARTIDOS P, (
        ...
        WHERE SUB.CONTEO = (    -- EL CONTEO DEBE DE SER IGUAL QUE EL M¡XIMO PARA
                                -- SACAR LAS SIGLAS DEL M¡XIMO
...
-- votante ha participado en una consulta, mostrando el resultado 
-- de manera descendente en cuanto a n√∫mero de participaciones. 
-- Solo se mostraran aquellos votantes cuya participaci√≥n ha 
...
-- 1, 3 o 9. Personaliza el titulo de dichas columnas.
    ...
    /*
        INSTR(cadena, subcadena, posicion, ocurrencia)
            ...
            * posicion -> posiciÛn donde comienza la b˙squeda 
...
-- encontrarse en situaci√≥n laboral de 'Activo'.
