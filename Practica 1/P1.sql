...
-- anterior y los actuales.
    ...
    -- AQUI DEBE DE HABER 18 
    SELECT * FROM VOTANTES;
    -- BORRAMOS EL ÚLTIMO INSERTADO 
    DELETE FROM VOTANTES
    WHERE DNI = 30653845;
    -- AHORA DEBE DE MOSTRAR 18 
    SELECT * FROM VOTANTES;
...
-- 9. Mostrar el nombre de los eventos que tienen lugar y que se encuentran 
-- en la tabla eventos, así como su tipo ('Europeas', 'Generales', 'Autonomicas', 
-- 'Locales', 'Otras') y la fecha en la que se desarrollarán. Únicamente se 
-- deberá mostrar el nombre del evento, el tipo y la fecha del mismo. 

    SELECT NOMBRE, TIPO, FECHA FROM EVENTOS; 

-- 10. Realizar la concatenación del nombre del evento y su tipo, de manera 
-- que sólo se mostrará lo que se muestra más abajo. El nombre de la columna 
-- será “Convocatoria”.

    SELECT (NOMBRE || ' de tipo ' || TIPO) AS CONVOCATORIAS FROM EVENTOS; 

-- 11. Realizar concatenaciones de columnas en diferentes tablas de la base   
-- de datos. De esta forma, los alumnos se familiarizarán con la consulta SELECT 
-- y con el renombrado de columnas.
